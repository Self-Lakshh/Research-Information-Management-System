...
export const Showcase = ({
    ...
    return (
        ...
        >
            <div className="relative overflow-hidden rounded-xl sm:rounded-2xl lg:rounded-3xl border border-border/50 bg-card aspect-[16/9] sm:aspect-[21/9] lg:aspect-[2.5/1]">
                <AnimatePresence
                    initial={false}
                    custom={direction}
                    mode="popLayout"
